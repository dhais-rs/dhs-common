...
public class WxPayment {
     ...
     * @param auth_code 扫码支付授权码
     * @param paternerKey
     * @return
     */
    public static Map<String, String> buildMicropayParas(String appid, String sub_appid, String mch_id,
        String sub_mch_id,
    ...
    public static Map<String, String> buildUnifiedOrderParasMap(String appid, String sub_appid, String mch_id,
        ...
        String product_id, String scene_info, String openid) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("appid", appid);
        params.put("sub_appid", sub_appid);
        params.put("mch_id", mch_id);
     ...
     * @return
     */
    public static Map<String, String> buildOrderPaySign(String appid, String partnerid, String prepayid,
        String trade_type, String partnerKey) {
        Map<String, String> params = new HashMap<String, String>();
